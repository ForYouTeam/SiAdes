                    ...
                    success: function(result) {
                        ...
                        <div class="row">
                            ...
                            <label>Tempat Lahir</label>
                                <input type="text" class="form-control" id="tmpLahir" name="tmpLahir" value="`+data.tmpLahir+`">
                            </div>
                            <div class="form-group col-6">
                        ...
                        <div class="row">
                            ...
                            <label>Status Keluarga</label>
                                <input type="text" class="form-control" id="statKeluarga" name="statKeluarga" value="`+data.statKeluarga+`">
                            </div>
                            <div class="form-group col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label>Suku</label>
                                    <input type="text" class="form-control" id="suku" name="suku" value="`+data.suku+`">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-6">
                            <label>Hidup</label>
                                <input type="text" class="form-control" id="hidup" name="hidup" value="`+data.hidup+`">
                            </div>
                            <div class="form-group col-6">
