        ...
        <div class="card-body py-5">
            <div
                ...
                <div class="ml-3 ml-md-0 ml-xl-3">
                    <h5 class="text-white font-weight-bold">Total Surat Keluar</h5>
                    <p class="mt-2 text-white card-text">{{$data['arsipkeluar']}}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card bg-google d-flex align-items-center">
        <div class="card-body py-5">
            <div
                ...
                <div class="ml-3 ml-md-0 ml-xl-3">
                    <h5 class="text-white font-weight-bold">Total Surat MasuK</h5>
                    <p class="mt-2 text-white card-text">{{$data['arsipmasuk']}}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card bg-twitter d-flex align-items-center">
        <div class="card-body py-5">
            <div
                ...
                <div class="ml-3 ml-md-0 ml-xl-3">
                    <h5 class="text-white font-weight-bold">Total Data Barang</h5>
                    <p class="mt-2 text-white card-text">{{$data['barang']}}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body py-5">
            <div
                ...
                <div class="ml-3 ml-md-0 ml-xl-3">
                    ...
                    <p class="mt-2 text-white card-text">{{$data['penduduk']}}</p>
                </div>
            </div>
        </div>
    </div>
