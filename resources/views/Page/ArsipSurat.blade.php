                ...
                <form id="formSimpan" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="date" class="form-control costume-outline" id="tgl_surat" name="tgl_surat"
                                placeholder="Tanggal Surat">
                            <p class="text-danger miniAlert text-capitalize" id="alert-TglSurat"></p>
                        </div>
                        <div class="form-group col-4">
                            <label>File upload</label>
                            <input type="file" class="form-control costume-outline" id="format_file" name="format_file">
