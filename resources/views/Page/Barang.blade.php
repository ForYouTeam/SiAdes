                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" id="btnEdit" data-id="{{ $d->id }}" data-bs-toggle="modal"
                                            data-bs-target="#modal-univ" class="btn btn-primary btn-rounded btn-icon">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group row col-6">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" class="form-control costume-outline" id="hargatotal" value=""
                                            placeholder="Harga Total" disabled>
